          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
            ...
            <div className="py-4">
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-text-4-500">
              ...
              <div className="mb-6">
                {product.discountPrice ? (
                  <div className="flex items-center">
                    <span className="text-3xl font-bold text-text-3-500">
                      ${product.discountPrice}
                    </span>
                    <span className="text-xl text-text-4-500 line-through ml-3">
                      ${product.price}
                    </span>
              ...
              {/* Description */}
              <p className="text-text-4-500 mb-6 leading-relaxed">
                {product.description}
              </p>
              ...
              <div className="mb-6">
                ...
                <ol className="list-disc list-inside text-text-4-500 space-y-1">
              ...
              <div className="border-t border-gray-200 pt-4">
                <div className="grid grid-cols-2 gap-4 text-sm text-text-4-500">
                  <div>
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                <div className="flex items-center text-sm text-text-4-500">
                  <FaTruck className="text-text-3-500 mr-2" /> Free shipping
                </div>
                <div className="flex items-center text-sm text-text-4-500">
                  <FaUndo className="text-text-3-500  mr-2" /> 30-day returns
                </div>
                <div className="flex items-center text-sm text-text-4-500">
                  <FaShieldAlt className="text-text-3-500  mr-2" /> 2-year
                  warranty
                </div>
              </div>
            </div>
